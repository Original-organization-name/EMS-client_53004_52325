...
export class MedicalExaminationsService {
     ...
     */
    public addMedicalExam(employeeId: string, medicalExamination?: MedicalExamination, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<MedicalExaminationModel>;
    public addMedicalExam(employeeId: string, medicalExamination?: MedicalExamination, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<MedicalExaminationModel>>;
    public addMedicalExam(employeeId: string, medicalExamination?: MedicalExamination, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<MedicalExaminationModel>>;
    public addMedicalExam(employeeId: string, medicalExamination?: MedicalExamination, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (employeeId === null || employeeId === undefined) {
            throw new Error('Required parameter employeeId was null or undefined when calling addMedicalExam.');
        }
